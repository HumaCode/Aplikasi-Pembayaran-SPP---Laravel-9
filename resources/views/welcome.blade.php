...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @else
            <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Login Operator</a>
            <a href="{{ route('login.wali') }}" class=" ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Login
                Wali
                Murid</a>
